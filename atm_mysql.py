...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        password_label=tk.Label(self,text=(f'Welcome {user_display_name} to Spain Banking'),font=('BatmanForeverAlternate',17),bg='#3d3d5c',fg='white').pack(pady=10)
    ...
    def __init__(self, parent, controller):
        ...
        def withdraw(amount):
            ...
            if amount>current_balance:
                ...
                mydb=mysql.connector.connect(host="localhost",user="root",password='likhi')
